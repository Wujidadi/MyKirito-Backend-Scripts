...
function buildPlayerConfig(): void
{
    ...
    $configFile = STORAGE_DIR . DIRECTORY_SEPARATOR . 'configs' . DIRECTORY_SEPARATOR . "{$configName}.json";
    $configExampleFile = STORAGE_DIR . DIRECTORY_SEPARATOR . 'configs' . DIRECTORY_SEPARATOR . 'examples' . DIRECTORY_SEPARATOR . "{$configName}.json";
    ...
    {
        echo "Fail building config: Invalid JSON file at {$configFile}\n";
    }
}
